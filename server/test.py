...
def tts():
    ...
    voice_index = 1
    text = "Hello there, my name is Selena and I am excited to meet you!"
...
if __name__ == "__main__":
    ...
    sentence = "Hello there, my name is Selena and I am excited to meet you!"
    tortoise = Tortoise_API()
    audio_file_name = tortoise.call_api(sentence)
